  ...
  return (
    <div className="flex flex-col gap-y-4 relative">
      {showMentions && filteredMembers.length > 0 && (
        <div className="absolute bottom-full left-0 w-64 bg-white border rounded-md shadow-lg z-50 mb-2 overflow-hidden">
          ...
          {filteredMembers.map((member) => (
            <button
              ...
              className="w-full flex items-center gap-x-2 p-2 hover:bg-neutral-100 transition text-left"
            >
